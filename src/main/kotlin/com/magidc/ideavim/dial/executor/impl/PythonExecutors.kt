...
object PythonExecutors : ExecutorProvider {
    ...
    override fun buildExecutors(): List<Executor> {
        return listOf(
            ...
            wordSet(category, "class_decorators", "@property", "@classmethod", "@staticmethod", wholeWords = false),
            wordSet(category, "collection_types", "list(", "tuple(", "set(", "dict(", wholeWords = false),
            wordSet(category, "collection_operations", ".append(", ".extend(", ".insert(", ".remove(", ".pop(", wholeWords = false),
