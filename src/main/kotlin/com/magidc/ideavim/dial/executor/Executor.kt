...
private fun buildWordSetExecutors(
  ...
  return Executor(
    ...
    forwardTransform = { matchResult: MatchResult ->
      forwardMap[matchResult.value.lowercase()] ?: matchResult.value
    },
    backwardTransform = { matchResult: MatchResult ->
      backwardMap[matchResult.value.lowercase()] ?: matchResult.value
    },
