...
class CustomDefinitionsTest : BaseTest() {
  ...
  override fun getCustomDefinitions(): VimList {
    ...
    //        val normalizedCaseWordSet = createNormalizedCaseWordSet(listOf(VimString("one"),
    // VimString("two"), VimString("three")))
    val normalizedCaseWordSet =
      VimList(
        mutableListOf(
    ...
    //        val wordSet = createWordSet(listOf(VimString("un"), VimString("deux"),
    // VimString("trois")))
    val wordSet =
      VimList(
        mutableListOf(
    ...
    //        val normalizedCasePatterns = createNormalizedCasePattern(listOf(VimString("alpha"),
    // VimString("beta"), VimString("gamma")))
  ...
  fun testWordBoundaryPatterns() {
    ...
    assertThat(execute("pre" + CARET + "un"))
      .isEqualTo("pre" + CARET + "un") // Should not match within word
    assertThat(execute("" + CARET + "un.")).isEqualTo("" + CARET + "deux.")
  }
